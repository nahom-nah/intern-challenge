...
<div>
   <div class="d-flex justify-center py-8 blue ">
        <div class="font-weight-bold title white--text">Create Contact</div>
   </div>
...
export default  {
   ...
   methods:{
    ...
    if(this.base64){
        console.log('here base 64')
         this.$store.dispatch("contact/createContact",{formdata:this.formdata,base64:this.base64, name:this.file.name,type: this.file.type}).then(res=>{
            if(res){
                this.phone_no="{"
                this.$emit('clicked') 
            }
         ...
         this.$store.dispatch("contact/createContact",{formdata:this.formdata,base64:this.base64}).then(res=>{
            if(res){
                this.phone_no="{"
                this.$emit('clicked') 
            }
